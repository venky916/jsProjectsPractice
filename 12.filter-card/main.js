...
function filterCardsByCategory(extractCurrentCategory) {

    // comment below not works because we are working on th content which is already being displayed
    // if (extractCurrentCategory.toLowerCase() === "all") {
    //     return 
    // }
